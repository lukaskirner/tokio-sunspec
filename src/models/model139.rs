...
pub const ActCrv: Point<Model139, u16> = Point::new(0, 1, false);
pub const ModEna: Point<Model139, u16> = Point::new(1, 1, false);
pub const WinTms: Point<Model139, u16> = Point::new(2, 1, false);
pub const RvrtTms: Point<Model139, u16> = Point::new(3, 1, false);
pub const RmpTms: Point<Model139, u16> = Point::new(4, 1, false);

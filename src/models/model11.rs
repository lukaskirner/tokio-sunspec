...
pub const Nam: Point<Model11, String> = Point::new(7, 4, false);
pub const Ctl: Point<Model11, u16> = Point::new(11, 1, false);
pub const FrcSpd: Point<Model11, u16> = Point::new(12, 1, false);

...
pub const ActCrv: Point<Model136, u16> = Point::new(0, 1, true);
pub const ModEna: Point<Model136, u16> = Point::new(1, 1, true);
pub const WinTms: Point<Model136, u16> = Point::new(2, 1, true);
pub const RvrtTms: Point<Model136, u16> = Point::new(3, 1, true);
pub const RmpTms: Point<Model136, u16> = Point::new(4, 1, true);

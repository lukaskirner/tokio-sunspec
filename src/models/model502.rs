...
pub const Ctl: Point<Model502, u16> = Point::new(10, 1, true);
pub const CtlVend: Point<Model502, u32> = Point::new(11, 1, true);
pub const CtlVal: Point<Model502, i32> = Point::new(13, 1, true);

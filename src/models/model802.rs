...
pub const SocRsvMax: Point<Model802, u16> = Point::new(7, 1, false);
pub const SoCRsvMin: Point<Model802, u16> = Point::new(8, 1, false);
...
pub const CtrlHb: Point<Model802, u16> = Point::new(17, 1, false);
pub const AlmRst: Point<Model802, u16> = Point::new(18, 1, false);
...
pub const SetOp: Point<Model802, u16> = Point::new(48, 1, false);
pub const SetInvState: Point<Model802, u16> = Point::new(49, 1, false);

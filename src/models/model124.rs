...
pub const WChaMax: Point<Model124, u16> = Point::new(0, 1, false);
pub const WChaGra: Point<Model124, u16> = Point::new(1, 1, false);
pub const WDisChaGra: Point<Model124, u16> = Point::new(2, 1, false);
pub const StorCtl_Mod: Point<Model124, u16> = Point::new(3, 1, false);
pub const VAChaMax: Point<Model124, u16> = Point::new(4, 1, false);
pub const MinRsvPct: Point<Model124, u16> = Point::new(5, 1, false);
...
pub const OutWRte: Point<Model124, i16> = Point::new(10, 1, false);
pub const InWRte: Point<Model124, i16> = Point::new(11, 1, false);
pub const InOutWRte_WinTms: Point<Model124, u16> = Point::new(12, 1, false);
pub const InOutWRte_RvrtTms: Point<Model124, u16> = Point::new(13, 1, false);
pub const InOutWRte_RmpTms: Point<Model124, u16> = Point::new(14, 1, false);
pub const ChaGriSet: Point<Model124, u16> = Point::new(15, 1, false);

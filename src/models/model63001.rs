...
pub const int16_4: Point<Model63001, i16> = Point::new(7, 1, true);
...
pub const uint16_4: Point<Model63001, u16> = Point::new(13, 1, true);
...
pub const int32_3: Point<Model63001, i32> = Point::new(26, 1, true);
...
pub const uint32_3: Point<Model63001, u32> = Point::new(38, 1, true);
...
pub const ipaddr: Point<Model63001, u32> = Point::new(58, 1, true);
pub const ipaddr_u: Point<Model63001, u32> = Point::new(60, 1, false);
pub const int64: Point<Model63001, i64> = Point::new(62, 1, true);
...
pub const float32: Point<Model63001, f32> = Point::new(94, 2, true);
pub const float32_u: Point<Model63001, f32> = Point::new(96, 2, false);
pub const string: Point<Model63001, String> = Point::new(98, 16, true);

...
pub const GlblElCtl: Point<Model601, i32> = Point::new(18, 1, false);
pub const GlblAzCtl: Point<Model601, i32> = Point::new(20, 1, false);
pub const GlblCtl: Point<Model601, u16> = Point::new(22, 1, false);
